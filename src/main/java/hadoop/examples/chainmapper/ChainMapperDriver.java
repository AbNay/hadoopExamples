...
public class ChainMapperDriver {
	...
	public static void main(String[] args) throws Exception {
		...
		ChainMapper.addMapper(job, ExampleMappers.SplitMapper.class, LongWritable.class, Text.class, Text.class, IntWritable.class,
				splitMapConfig);
		Configuration lowerCaseMapConfig = new Configuration(false);
		ChainMapper.addMapper(job, ExampleMappers.LowerCaseMapper.class, Text.class, IntWritable.class, Text.class, IntWritable.class,
				lowerCaseMapConfig);
